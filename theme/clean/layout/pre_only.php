...
<section id="region-bs-main" class="span6 pull-right">
	<?php echo $coursecontentheader; ?>
	<?php echo $OUTPUT->main_content(); ?>
	<?php echo $coursecontentfooter; ?>
</section>
<aside id="region-pre" class="span3 block-region region-content desktop-first-column">
<?php echo $side_pre; ?>
</aside>
...
<aside id="region-pre" class="span4 block-region region-content desktop-first-column">
	<?php 
